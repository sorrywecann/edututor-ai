...
| REPO-1 | jeden projektovy repo → edotutor (s O) + edututor-releases (s U) + planovany sorrywecan/edututor-ai | Nie | Stredne (mozny "preklep" flag pri audite) |
...
|---|---|---|
| `princeofwellness/edotutor` (s **O**) | **Private** | Source-of-truth pre vyvoj; aktualne v0.7.2 |
...
| `sorrywecan/edututor-ai` | Planovany (W9) | Cisty open-source release bez AI/Claude referencii v historii |
...
**Datum pivohu:** v0.5.0 cutover (2026-05-29) — od tej verzie verejne releases prestali ist na `princeofwellness/edotutor` (zostali na v0.4.5) a presli na `princeofwellness/edututor-releases`.

**Dovod:** Source repo obsahuje internal dev artefakty (Claude transcripts, plans, audit dokumenty) ktore nemozno publikovat ako open-source. Public artifacts repo dava distribucnu funkciu (Electron auto-updater stahuje z public repa) bez exponovania source-history. Future `sorrywecan/edututor-ai` bude cisty MIT-licensed open-source mirror.
...
**Dokaz:** `desktop/main.mjs` (`UE5_RELEASE_REPO = 'princeofwellness/edututor-releases'`), `gh release list --repo princeofwellness/edututor-releases --limit 20`, `docs/MASTER_PLAN.md` (W9 sorrywecan/edututor-ai roadmap).
...
- `docs/MASTER_PLAN.md` — workstreams W6 (cleanup), W9 (sorrywecan/edututor-ai cutover)
