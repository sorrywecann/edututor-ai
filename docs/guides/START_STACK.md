...
```powershell
git clone https://github.com/sorrywecann/edututor-ai.git edututor-ai-sandbox-test
git clone -b Edutor_UnrealEngine https://github.com/sorrywecann/edututor-ai.git edututor-ai-sandbox-ue5-latest
```

**Backend deps** (Python 3.11+):
```powershell
cd edututor-ai-test\tutor-service
python -m venv .venv
