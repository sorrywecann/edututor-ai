...
|---|---|---|
| `sorrywecann/edututor-ai` (s **O**) | **Private** | Source-of-truth pre vyvoj; aktualne v0.7.2 |
...
**Datum pivohu:** v0.5.0 cutover (2026-05-29) — od tej verzie verejne releases prestali ist na `sorrywecann/edututor-ai` (zostali na v0.4.5) a presli na `princeofwellness/edututor-releases`.
