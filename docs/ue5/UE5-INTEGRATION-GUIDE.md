...
- Validácia rig→viseme (bez Rolanda): otvor [`/avatar-debug/simulator`](http://localhost:3000/avatar-debug/simulator) v prehliadači, scrubuj timeline, sleduj farebné viseme pills
