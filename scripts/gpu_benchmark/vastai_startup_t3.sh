...
set -e
echo "============================================"
echo "  EduTutor.AI GPU Benchmark — T3 A100 40GB"
echo "  $(date)"
echo "============================================"
...
echo "[5/7] Pulling models (qwen2.5:7b + 14b + 32b — 30+ GB, may take 10 min)..."
ollama pull qwen2.5:7b
ollama pull qwen2.5:14b
ollama pull qwen2.5:32b || echo "WARN: 32b pull failed (40GB VRAM tight); falling back to 14b for benchmark"
...
echo "[7/7] Ready — T3 A100 40GB provisioned."
